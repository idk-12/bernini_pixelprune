#!/bin/bash
# PixelPrune: Evaluation on GUI Understanding Benchmarks
#
# Usage:
#   bash scripts/eval_gui.sh [MODEL_PATH] [DATASETS] [GPU_IDS]
...
DATASETS="${2:-ScreenSpot_v2_Web ScreenSpot_v2_Mobile ScreenSpot_v2_Desktop ScreenSpot_Pro_Scientific ScreenSpot_Pro_Office ScreenSpot_Pro_OS ScreenSpot_Pro_Creative ScreenSpot_Pro_Development ScreenSpot_Pro_CAD}"
...
mkdir -p "$LMUData"
export pred_root="${VLMEVALKIT_DIR}/outputs/pixelprune_gui"

echo "========================================"
echo "PixelPrune: GUI Understanding Eval"
