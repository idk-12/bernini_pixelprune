...
PREFIX="${OUT_DIR}/source_case1_baseline"
...
echo "Log:     ${PREFIX}.stdout.log"
echo

CUDA_VISIBLE_DEVICES="${GPU_IDS}" \
PIXELPRUNE_ENABLED=false \
VERBOSE=true \
...
e2e_path = "/data/lijie/PixelPrune/tmp/source_case1_baseline.e2e.rank0.jsonl"
...
ls -lh "${PREFIX}".stdout.log "${PREFIX}".e2e.rank0.jsonl 2>/dev/null || true
