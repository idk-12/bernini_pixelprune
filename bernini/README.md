...
For the source-visual PixelPrune integration, paired EditVerse/OpenVE benchmark
scripts, output layout, and profiling metric definitions, see the
**[PixelPrune usage guide](scripts/pixelprune/README.md)**.
