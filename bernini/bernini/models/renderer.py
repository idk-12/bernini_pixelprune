...
class BerniniRendererConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        dit_attention_backend: str = "auto",
        rainfusion_sparsity: float = 0.7,
        rainfusion_start_step: int = 10,
        rainfusion_block_size: int = 128,
        **kwargs,
    ):
        ...
        self.dit_attention_backend = dit_attention_backend
        self.rainfusion_sparsity = rainfusion_sparsity
        self.rainfusion_start_step = rainfusion_start_step
        self.rainfusion_block_size = rainfusion_block_size
